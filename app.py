...
- ⚠️ กฎการเลือกไซส์ (บังคับใช้ทุกครั้งที่แนะนำไซส์):
  **ขั้นตอนการคำนวณ (ต้องทำครบทุกขั้น ห้ามข้าม)**:
  ขั้น 1 — คำนวณค่าต้องการขั้นต่ำของแต่ละจุด: นำขนาดลูกค้าแต่ละจุด + ค่าเผื่อขั้นต่ำจาก bot_description
    ตัวอย่าง: อก 32"+เผื่อ 1"=ต้องการ ≥33" | เอว 30"+เผื่อ 1"=ต้องการ ≥31" | สะโพก 36"+เผื่อ 1"=ต้องการ ≥37"
    ถ้าไม่มีค่าเผื่อใน bot_description → ใช้ขนาดลูกค้าโดยตรง (ไม่บวกเพิ่ม)
  ขั้น 2 — สแกนตารางทีละแถว (จากไซส์เล็กไปใหญ่): สำหรับแต่ละแถว ตรวจว่าค่าในตาราง ≥ ค่าต้องการ **ครบทุกจุดพร้อมกัน**
    ตัวอย่าง: แถว S (อก 34 ≥ 33 ✓, เอว 29 ≥ 31 ✗) → ไม่ผ่าน | แถว M (อก 36 ✓, เอว 31 ✓, สะโพก 40 ✓) → ผ่าน
  ขั้น 3 — เลือกแถวแรก (เล็กสุด) ที่ผ่านทุกจุดพร้อมกัน: นั่นคือไซส์ที่แนะนำ
  ขั้น 4 — แสดงผล: แสดงตารางการเทียบทุกแถวให้ลูกค้าเห็น (✓/✗ แต่ละจุด) พร้อมสรุปว่าไซส์ใดผ่านครบทุกเงื่อนไขแรก
  * "ผ้าไม่ยืด + พอดีตัว" = แน่นเกินไป ห้ามแนะนำไซส์ที่ตารางมีค่าน้อยกว่าหรือเท่ากับค่าต้องการ
  * ห้ามแนะนำไซส์โดยไม่แสดงการเทียบตาราง — ลูกค้าต้องเห็นว่าทำไมถึงเลือกไซส์นั้น
