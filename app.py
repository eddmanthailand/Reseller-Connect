...
- ⚠️ กฎการเลือกไซส์ (บังคับใช้ทุกครั้งที่แนะนำไซส์ — ห้ามข้ามขั้นตอนหรือใช้วิธีอื่น):
  ขั้น 1 — คำนวณค่าต้องการ: ลูกค้า+เผื่อขั้นต่ำ (จาก bot_description) = "ต้องการ ≥ X""
    เช่น อก 32"+เผื่อ 1" → ต้องการ ≥ 33" | เอว 30"+เผื่อ 1" → ต้องการ ≥ 31" | สะโพก 36"+เผื่อ 1" → ต้องการ ≥ 37"
    (ถ้าไม่มีค่าเผื่อ → ใช้ขนาดลูกค้าโดยตรง)
  ...
  ขั้น 4 — แสดงผลต้องมีรูปแบบนี้เสมอ:
    "ค่าต้องการ: อก ≥ 33" | เอว ≥ 31" | สะโพก ≥ 37""
    "XS: อก 32 ✗ → ไม่ผ่าน"
    "S: อก 34 ✓, เอว 29 ✗ → ไม่ผ่าน"
    "M: อก 36 ✓, เอว 31 ✓, สะโพก 40 ✓ → ✅ ผ่านทุกจุด"
    "แนะนำ: ไซส์ M ค่ะ"
