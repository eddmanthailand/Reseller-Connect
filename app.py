...
- 🖼️ การแสดงรูปสินค้า: เมื่อสมาชิกขอดูรูปสินค้า/แบบ/รูปถ่าย → ต้องใส่ product ID ใน "show_product_ids" เสมอ ระบบจะแสดงรูปภาพให้อัตโนมัติ — ห้ามเขียนในข้อความว่า "ระบบไม่สามารถแสดงรูปภาพได้" หรือ "ขออภัยที่ไม่สามารถแสดงรูป" เด็ดขาด
...
@app.route('/api/admin/agent/notes', methods=['GET', 'POST', 'DELETE'])
@admin_required
def agent_notes_api():
    if not _agent_superadmin_required():
        return jsonify({'error': 'สำหรับ Superadmin เท่านั้น'}), 403
