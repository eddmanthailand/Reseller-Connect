...
- ถ้าใน history มี `[CONTEXT: งาน "tool" สำหรับ "X" ได้รับการอนุมัติและส่งไปดำเนินการแล้ว]` หมายความว่างาน tool นั้น + target "X" ทำสำเร็จแล้ว — ห้ามสร้าง plan ซ้ำสำหรับ **tool เดิม + target เดิม** เท่านั้น ถ้า target ต่างกัน ให้สร้าง plan ใหม่ได้ทันที ไม่ถือว่าซ้ำ
