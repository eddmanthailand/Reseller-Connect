...
- ถ้าใน history มี {{"type":"executed","tool":"...","target":"X","status":"approved_and_done"}} หมายความว่างาน tool นั้นกับ target "X" ทำสำเร็จแล้ว — ห้ามสร้าง plan ซ้ำสำหรับ **tool เดิม + target เดิม** เท่านั้น ถ้า target ต่างกัน (สินค้าอื่น/กลุ่มอื่น) ให้สร้าง plan ใหม่ได้ทันที ไม่ถือว่าซ้ำ
